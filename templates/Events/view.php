            ...
            <div id="dados-part" class="content fade" role="tabpanel" aria-labelledby="dados-part-trigger">
                <div style="display:flex; flex-direction:row; justify-content:center; align-items:center; margin:15px 0;">
                    <div class="form-group" style="margin: 0 5px; width:30%">
                        ...
                        <input disabled value="<?= $event->bi ?>" name="bi" type="text" class="form-control" placeholder="Numero de BI">
                    </div>
                    <div class="form-group" style="margin: 0 5px; width:30%">
                        <label>Contratante</label>
                        <select disabled name="customer_id" class="form-control" value="<?= $event->customer_id ?>" required>
                    ...
                    <div class="form-group" style="margin: 0 5px; width:30%">
                        ...
                        <input disabled value="<?= $event->name ?>" name="name" type="text" class="form-control" placeholder="Evento">
                    </div>
                </div>
                ...
                <div style="display:flex; flex-direction:row; justify-content:center; align-items:center; margin:15px 0;">
                    <div class="form-group" style="margin: 0 5px; width:45%">
                        ...
                        <input disabled value="<?= $event->address ?>" name="address" type="text" class="form-control" placeholder="Local do evento">
                    </div>
                    <div class="form-group" style="margin: 0 5px; width:45%">
                        <label for="exampleInputName1">Cidade do evento</label>
                        <input disabled value="<?= $event->city ?>" name="city" type="text" class="form-control" placeholder="Cidade do evento">
                    </div>
                </div>
                ...
                <div style="display:flex; flex-direction:row; justify-content:center; align-items:center; margin:15px 0;">
                    <div class="form-group" style="margin: 0 5px; width:30%">
                        ...
                        <select disabled name="tipo_id" class="form-control" required>
                    ...
                    <div class="form-group" style="margin: 0 5px; width:30%">
                        ...
                        <select disabled name="porposal_id" class="form-control" required>
                    ...
                    <div class="form-group" style="margin: 0 5px; width:30%">
                        ...
                        <div class="input-group">
                            ...
                            <input disabled value="<?= $event->event_date ?>" name="event_date" type="text" class="form-control form_date" placeholder="dd/mm/yy">
                        </div>
                    </div>
                </div>
                <div style="display:flex; flex-direction:row; justify-content:center; align-items:center; margin:15px 0;">
                    <div class="form-group" style="margin: 0 5px; width:30%">
                        ...
                        <select disabled name="hours" class="form-control" required>
                    ...
                    <div class="form-group" style="margin: 0 5px; width:30%">
                        ...
                        <input disabled value="<?= $event->color ?>" name="color" type="text" class="form-control" placeholder="Cor do enxoval">
                    </div>
                </div>
            ...
            <div id="observacao-part" class="content fade" role="tabpanel" aria-labelledby="observacao-part-trigger">
                <div style="display:flex; flex-direction:row; justify-content:center; align-items:center;">
                    <div class="form-group" style="margin: 0 5px; width:45%">
                        ...
                        <input disabled value="<?= $event->inicio ?>" name="inicio" type="text" class="form-control" id="exampleInputEmail1" placeholder="Hora inicio festa">
                    </div>
                    <div class="form-group" style="margin: 0 5px; width:45%">
                        <label>Turno do evento</label>
                        <select disabled name="turno" class="form-control" required>
                ...
                <div style="display:flex; flex-direction:row; justify-content:center; align-items:center;">
                    <div class="form-group" style="margin: 0 5px; width:30%">
                        ...
                        <select disabled name="local" class="form-control" required>
                            <option disabled>Selecione um tipo</option>
                    ...
                    <div class="form-group" style="margin: 0 5px; width:30%">
                        ...
                        <input disabled value="<?= $event->qtd_bar ?>" name="qtd_bar" type="number" class="form-control" id="exampleInputPassword1" placeholder="Quantidade de bares">
                    </div>
                    <div class="form-group" style="margin: 0 5px; width:30%">
                        <label>Opção sexual do cliente</label>
                        <select disabled name="sexual" class="form-control" required>
                ...
                <div style="display:flex; flex-direction:row; justify-content:center; align-items:center;">
                    <div class="form-group" style="margin: 0 5px; width:30%">
                        ...
                        <select disabled name="preferido" class="form-control" required>
                    ...
                    <div class="form-group" style="margin: 0 5px; width:30%">
                        ...
                        <select disabled name="consumo" class="form-control" required>
                ...
                <div style="display:flex; flex-direction:row; justify-content:center; align-items:center;">
                    <div class="form-group" style="margin: 0 5px; width:15%">
                        ...
                        <input disabled value="<?= $event->gelo_diamante ?>" name="gelo_diamante" type="number" class="form-control" id="exampleInputPassword1" placeholder="Quantidade de gelo diamante">
                    </div>
                    <div class="form-group" style="margin: 0 5px; width:15%">
                        <label for="exampleInputUnit1">Gelo esfera</label>
                        <input disabled value="<?= $event->gelo_esfera ?>" name="gelo_esfera" type="number" class="form-control" id="exampleInputPassword1" placeholder="Quantidade de gelo esfera">
                    </div>
                    <div class="form-group" style="margin: 0 5px; width:15%">
                        <label for="exampleInputUnit1">Gelo cubo</label>
                        <input disabled value="<?= $event->gelo_cubo ?>" name="gelo_cubo" type="number" class="form-control" id="exampleInputPassword1" placeholder="Quantidade de gelo cubo">
                    </div>
                    <div class="form-group" style="margin: 0 5px; width:15%">
                        <label for="exampleInputUnit1">Gelo personalizado</label>
                        <input disabled value="<?= $event->gelo_personalizado ?>" name="gelo_personalizado" type="number" class="form-control" id="exampleInputPassword1" placeholder="Quantidade de gelo personalizado">
                    </div>
                    <div class="form-group" style="margin: 0 5px; width:15%">
                        <label for="exampleInputUnit1">Gelo flower</label>
                        <input disabled value="<?= $event->gelo_flower ?>" name="gelo_flower" type="number" class="form-control" id="exampleInputPassword1" placeholder="Quantidade de gelo flower">
                    </div>
                </div>
                <div style="display:flex; flex-direction:row; justify-content:center; align-items:center;">
                    <div class="form-group" style="margin: 0 5px; width:30%">
                        <label>Faixa etária dos convidados</label>
                        <select disabled name="etaria" class="form-control" required>
                    ...
                    <div class="form-group" style="margin: 0 5px; width:30%">
                        ...
                        <select disabled name="classe" class="form-control" required>
            ...
            <div id="bebidas-part" class="content fade" role="tabpanel" aria-labelledby="bebidas-part-trigger">
                <div style="display:flex; flex-direction:row; justify-content:center; align-items:center;">
                    <div class="form-group" style="margin: 0 5px; width:19%">
                        <label>Vodka</label>
                        <select disabled name="vodka_id" class="form-control" required>
                    ...
                    <div class="form-group" style="margin: 0 5px; width:19%">
                        ...
                        <select disabled name="espumante_id" class="form-control" required>
                    ...
                    <div class="form-group" style="margin: 0 5px; width:19%">
                        <label>Whisky</label>
                        <select disabled name="whisky_id" class="form-control" required>
                    ...
                    <div class="form-group" style="margin: 0 5px; width:19%">
                        <label>Vinho</label>
                        <select disabled name="vinho_id" class="form-control" required>
                ...
                <div style="display:flex; flex-direction:row; justify-content:center; align-items:center;">
                    <div class="form-group" style="margin: 0 5px; width:19%">
                        ...
                        <select disabled name="aperitivo1" class="form-control" required>
                    ...
                    <div class="form-group" style="margin: 0 5px; width:19%">
                        ...
                        <select disabled name="aperitivo2" class="form-control" required>
                            <option disabled>Selecione um aperitivo</option>
                    ...
                    <div class="form-group" style="margin: 0 5px; width:19%">
                        ...
                        <select disabled name="aperitivo3" class="form-control" required>
                            <option disabled>Selecione um aperitivo</option>
                    ...
                    <div class="form-group" style="margin: 0 5px; width:19%">
                        ...
                        <select disabled name="aperitivo4" class="form-control" required>
                            <option disabled>Selecione um aperitivo</option>
                    ...
                    <div class="form-group" style="margin: 0 5px; width:19%">
                        ...
                        <select disabled name="aperitivo5" class="form-control" required>
                            <option disabled>Selecione um aperitivo</option>
                ...
                <div style="display:flex; flex-direction:row; justify-content:center; align-items:center;">
                    <div class="form-group" style="margin: 0 5px; width:30%">
                        ...
                        <select disabled name="agua_id" class="form-control" required>
                    ...
                    <div class="form-group" style="margin: 0 5px; width:30%">
                        ...
                        <select disabled name="tonica_id" class="form-control" required>
                    ...
                    <div class="form-group" style="margin: 0 5px; width:30%">
                        ...
                        <select disabled name="coco_id" class="form-control" required>
                ...
                <div style="display:flex; flex-direction:row; justify-content:center; align-items:center;">
                    <div class="form-group" style="margin: 0 5px; width:30%">
                        <label>Saque</label>
                        <select disabled name="saque_id" class="form-control" required>
                    ...
                    <div class="form-group" style="margin: 0 5px; width:30%">
                        <label>Run</label>
                        <select disabled name="run_id" class="form-control" required>
                    ...
                    <div class="form-group" style="margin: 0 5px; width:30%">
                        <label>Cachaça</label>
                        <select disabled name="cachaca_id" class="form-control" required>
            ...
            <div id="consumo-part" class="content fade" role="tabpanel" aria-labelledby="consumo-part-trigger">
                <div style="display:flex; flex-direction:row; justify-content:center; align-items:center;">
                    <div class="form-group" style="margin: 0 5px; width:40%">
                        ...
                        <div class="input-group">
                            <input disabled value="<?= $event->provisionado ?>" name="provisionado" type="text" class="form-control din" placeholder="Consumo provisionado">
                        </div>
                    </div>
                    <div class="form-group" style="margin: 0 5px; width:40%">
                        <label for="exampleInputUnit1">Consumo sugerido</label>
                        <div class="input-group">
                            <input disabled value="<?= $event->sugerido ?>" name="sugerido" type="text" class="form-control din" placeholder="Consumo sugerido">
                        </div>
                    </div>
                </div>
                <button type="button" class="btn btn-block btn-secondary btn-lg ant" style="width: 10%">Anterior</button>
            ...
            <div id="custos-part" class="content fade" role="tabpanel" aria-labelledby="custos-part-trigger">
                <div style="display:flex; flex-direction:row; justify-content:center; align-items:center;">
                    <div class="form-group" style="margin: 0 5px; width:40%">
                        ...
                        <div class="input-group">
                            <input disabled value="<?= $event->receitapb ?>" name="receitapb" type="text" class="form-control din" placeholder="Receita provisionada bebida">
                        </div>
                    </div>
                    <div class="form-group" style="margin: 0 5px; width:40%">
                        <label for="exampleInputUnit1">Receita provisionada insumo</label>
                        <div class="input-group">
                            <input disabled value="<?= $event->receitapi ?>" name="receitapi" type="text" class="form-control din" placeholder="Receita provisionada insumo">
                        </div>
                    </div>
                </div>
                <button type="button" class="btn btn-block btn-secondary btn-lg ant" style="width: 10%">Anterior</button>
            ...
            <div id="casting-part" class="content fade" role="tabpanel" aria-labelledby="casting-part-trigger">
                <div style="display:flex; flex-direction:row; justify-content:center; align-items:center;">
                    <div class="form-group" style="margin: 0 5px; width:30%">
                        ...
                        <select disabled name="casting_uniform" class="form-control" required>
                        ...
                        <table class="cast">
                            <tr>
                                <div class="casting" style="display:flex; flex-direction:row; justify-content:center; align-items:center; margin:5px;">
                                    <select disabled name="casting_people[]" class="form-control select2 " style="width: 70%;" tabindex="-1" aria-hidden="true">
