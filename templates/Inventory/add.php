<div class="card card-outline card-secondary" style="margin:20px;">
    ...
    <div class="card-body">
        <div class="btn-group">
            <button type="button" class="btn btn-info" style="cursor:default">Total de coquetel Disponiveis</button>
                ...
                <div id="drk" class="form-group" style="display:flex; flex-direction:column; justify-content:center; align-items:center;">
                    <div style="display:flex; flex-direction:row; justify-content:center; align-items:center; width:100%;">
                        ...
                        <div style="display:flex; flex-direction:row; justify-content:center; align-items:center;">
                            ...
                            <input onChange="change(this)" class="form-control num" name="number[id][]" type="number" value="0" style="width:25%;" readonly>
