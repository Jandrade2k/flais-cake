<div class="card card-outline card-secondary" style="margin:20px;">
    ...
    <div class="card-body">
        ...
        <div class="form-group">
            <label>Coqueteis selecionados</label>
    ...
    <div class="card-footer">
        ...
        <a data-toggle="tooltip" data-placement="bottom" title="Gerar PDF" href="<?= $this->Url->build(['action' => 'pdf', $inventory->event]); ?>" class="btn btn-warning"><i class="far fa-file-pdf"></i></a>
    </div>
    <?= $this->Form->end(); ?>
</div>