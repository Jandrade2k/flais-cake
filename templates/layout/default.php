...
<body class="hold-transition sidebar-mini">
    ...
    <script>
        <?php if (($this->request->getParam('action') == 'add' && $this->request->getParam('controller') == 'Drinks') || ($this->request->getParam('action') == 'edit' && $this->request->getParam('controller') == 'Drinks')) { ?>
